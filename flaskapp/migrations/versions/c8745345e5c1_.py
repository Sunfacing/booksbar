...
Revision ID: c8745345e5c1
Revises: 
Create Date: 2021-11-01 17:02:35.151054
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['isbn_id'], ['category_list.id'], ),
    sa.ForeignKeyConstraint(['platform'], ['platform.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['Nomenclature_id'], ['category_list.id'], ),
