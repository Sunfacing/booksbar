...
Revision ID: f5cd64156df2
Revises: 
Create Date: 2021-11-03 12:00:03.883977
...
def upgrade():
    ...
    sa.Column('subcategory_id', sa.String(length=30), nullable=True),
    ...
    op.create_table('eslite_to_kings_category',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('category_id', sa.Integer(), nullable=True),
    sa.Column('category', sa.String(length=30), nullable=True),
    sa.Column('kingstone_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['kingstone_id'], ['category_list.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('momo_to_kings_category',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('show_priority', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['category_list.id'], ),
    sa.ForeignKeyConstraint(['platform'], ['platform.id'], ),
    ...
    sa.ForeignKeyConstraint(['isbn_id'], ['book_info.id'], ),
    sa.ForeignKeyConstraint(['platform'], ['platform.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('momo_to_kings_category')
    op.drop_table('eslite_to_kings_category')
